...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(PWR_EN_SENSORS_GPIO_Port, PWR_EN_SENSORS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : LD2_HEARTBEAT_Pin */
  GPIO_InitStruct.Pin = LD2_HEARTBEAT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(LD2_HEARTBEAT_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pin : PWR_EN_SENSORS_Pin */
  GPIO_InitStruct.Pin = PWR_EN_SENSORS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLDOWN;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(PWR_EN_SENSORS_GPIO_Port, &GPIO_InitStruct);
